...
async function main() {
  ...
  const partidosData = [
    ...
    { categoriaId: categoriaSenior.id, rival: 'CB Terrassa',    fecha: new Date('2025-12-06T11:00:00'), esLocal: false, campo: 'Camp Municipal de Terrassa',    resultado: '5-4',  descripcion: 'Remontada épica en el último inning tras ir 4-1 abajo.' },
    ...
    { categoriaId: categoriaSenior.id, rival: 'CB Mollet',      fecha: new Date('2026-02-28T11:00:00'), esLocal: false, campo: 'Camp Municipal de Mollet',      resultado: '6-5',  descripcion: 'Victoria agónica en Mollet con remontada en el noveno inning.' },
    ...
    { categoriaId: categoriaSub18.id, rival: 'CB Mataró',     fecha: new Date('2025-11-01T10:00:00'), esLocal: false, campo: 'Camp Municipal de Mataró',     resultado: '3-4',  descripcion: 'Derrota por un run en un partido muy igualado.' },
    ...
    { categoriaId: categoriaSub18.id, rival: 'CB Hospitalet', fecha: new Date('2026-02-21T10:00:00'), esLocal: false, campo: 'Camp Municipal de Hospitalet', resultado: '5-4',  descripcion: 'Victoria sufrida fuera de casa en extra innings.' },
    ...
    // ── SUB16 ──────────────────────────────────────────────────────
    { categoriaId: categoriaSub16.id, rival: 'CB Mataró',     fecha: new Date('2025-09-20T10:00:00'), esLocal: false, campo: 'Camp Municipal de Mataró',     resultado: '7-6',  descripcion: 'Victoria agónica con remontada en el noveno inning.' },
    ...
    { categoriaId: categoriaSub16.id, rival: 'CB Mataró',     fecha: new Date('2026-01-24T10:00:00'), esLocal: true,  campo: 'Campo Municipal Granollers',   resultado: '4-5',  descripcion: 'Derrota por un run ante el rival directo. La clasificación sigue abierta.' },
    ...
    { categoriaId: categoriaSub14.id, rival: 'CB Sabadell',     fecha: new Date('2025-11-08T10:00:00'), esLocal: false, campo: 'Camp Municipal de Sabadell',   resultado: '5-6',  descripcion: 'Derrota por un run en un partido muy igualado.' },
    ...
    { categoriaId: categoriaSub12.id, rival: 'CB Mataró',       fecha: new Date('2025-11-01T10:00:00'), esLocal: true,  campo: 'Campo Municipal Granollers',   resultado: '4-3',  descripcion: 'Victoria ajustada muy disputada. Gran nivel para la categoría.' },
    ...
    { categoriaId: categoriaSub12.id, rival: 'CB Mataró',       fecha: new Date('2026-02-21T10:00:00'), esLocal: false, campo: 'Camp Municipal de Mataró',     resultado: '3-2',  descripcion: 'Victoria ajustada ante Mataró en partido muy igualado.' },
    ...
    { categoriaId: categoriaSub10.id, rival: 'CB Vilafranca',   fecha: new Date('2025-11-22T10:00:00'), esLocal: false, campo: 'Camp Municipal de Vilafranca', resultado: '4-3',  descripcion: 'Victoria emocionante por un run. Los niños lo pasan genial jugando.' },
    ...
    { categoriaId: categoriaSub10.id, rival: 'CB Mataró',       fecha: new Date('2026-02-14T10:00:00'), esLocal: true,  campo: 'Campo Municipal Granollers',   resultado: '6-5',  descripcion: 'Victoria emocionante con carrera decisiva en el último inning.' },
